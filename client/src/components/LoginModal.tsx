        ...
        >
          ...
          >
            ...
            <div className="w-full space-y-4 px-5 pt-3 pb-5" dir="rtl">
              ...
              {/* Send OTP buttons — SMS, WhatsApp, or Call */}
            ...
            {step === "channel" && (
              <div className="p-6 space-y-5" dir="rtl">
                ...
                <div className="space-y-3">
                  {(["sms", "whatsapp", "call"] as OtpChannel[]).map((ch) => (
                    <label
                      key={ch}
