            ...
            {step === "channel" && (
              <div className="p-6 space-y-5" dir="rtl">
                ...
                <div className="space-y-3 pt-1">
                  ...
                  <button
                    type="button"
                    className="w-full flex items-center justify-center gap-3 rounded-xl border-2 bg-white px-4 py-3 text-sm font-semibold shadow-sm hover:bg-gray-50 active:scale-[0.98] transition-all duration-150"
                    style={{ borderColor: "oklch(0.88 0.04 122)", color: "#1a2010" }}
                    onClick={() => {
                      // Persist all collected registration data across the OAuth redirect
                      const payload = {
                        name: regName.trim(),
                        phone,
                        termsAccepted,
