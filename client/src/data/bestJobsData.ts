...
const BEST_JOBS_PAGES: BestJobsPage[] = [
  {
    slug: "delivery-jobs",
    title: "עבודות שליחויות הכי טובות בישראל | AvodaGo",
  ...
  {
    slug: "student-jobs",
    title: "עבודות לסטודנטים - המשרות הטובות ביותר | AvodaGo",
  ...
  {
    slug: "evening-jobs",
    title: "עבודות ערב - המשרות הטובות ביותר | AvodaGo",
  ...
  {
    slug: "weekend-jobs",
    title: "עבודות סוף שבוע - המשרות הטובות ביותר | AvodaGo",
  ...
  {
    slug: "immediate-jobs",
    title: "עבודות מיידיות - להתחיל היום | AvodaGo",
