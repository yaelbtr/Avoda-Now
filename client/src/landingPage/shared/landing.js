(function () {
  // אנימציית הגרדיאנט הנע על ה-SVG של "ללא עמלה"
  ...
  // IntersectionObserver להנפשת כניסה של אלמנטים עם .reveal
  ...
  // count-up animation עבור אלמנטים עם data-count
  ...
  function recalculate() {
    ...
    // אחוזי קטגוריות — מחושבים לפי תעריף (ניתן להתאים לדף ספציפי)
  ...
  // שליחת postMessage להורה (מסגרת iframe) בלחיצה על כפתורי הצטרפות
  ...
  // אובל "handwrite" מסביב לכותרת הסקשן
