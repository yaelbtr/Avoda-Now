...
const SECTIONS = [
  ...
  },
  {
    id: "minors",
    title: "11. קטינים",
    content: "השימוש בפלטפורמה כעובד מיועד למשתמשים מגיל 16 ומעלה בלבד. הפלטפורמה אינה אוספת מידע ביודעין ממשתמשים מתחת לגיל 16. אם נודע לנו שמשתמש מתחת לגיל 16 נעשה שימוש בפלטפורמה, נפעל למחיקת מידעו בהקדם האפשרי.",
  },
  {
    id: "policy-updates",
