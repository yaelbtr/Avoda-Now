...
const SECTIONS = [
  ...
  { id: "age", title: "4. גיל מינימלי לשימוש בפלטפורמה", content: "השימוש בפלטפורמה כעובד מותר למשתמשים מגיל 16 ומעלה בלבד. בהרשמה לפלטפורמה, המשתמש נדרש להזין את תאריך לידתו ומצהיר כי הפרטים שנמסרו על ידיו נכונים, מדויקים ומלאים. המשתמש מאשר כי ידוע לו שמסירת מידע שגוי עלולה להוביל להגבלת שימושו בפלטפורמה או חסימתו. המשתמש מצהיר ומאשר כי הפלטפורמה רשאית להסתמך על הצהרותיו, וכי אין היא מתחייבת לבצע אימות עצמאי של גילו או של כל פרט אחר שנמסר על ידו." },
  { id: "minor-employment", title: "4א. העסקת קטינים (גילאי 16–18)", content: `הפלטפורמה מאפשרת חיבור בין משתמשים, לרבות בין מעסיקים לבין עובדים בגילאי 16–18, וזאת מבלי שתהיה צד לכל התקשרות, הסכמה או מערכת יחסים בין הצדדים.

מעסיק הבוחר להתקשר עם עובד שגילו מתחת ל-18 מצהיר, מאשר ומתחייב כי:
(א) הוא מודע להוראות כל דין הנוגעות להעסקת קטינים, ובכלל זאת חוק עבודת הנוער והתקנות מכוחו;
(ב) הוא יעמוד בכל הדרישות החוקיות, לרבות אך לא רק: מגבלות שעות העבודה, סוגי העבודות המותרות, תנאי העבודה, וכל הוראה אחרת החלה עליו לפי דין;
(ג) הוא ידאג לקבלת כל אישור נדרש, לרבות אישור הורה ו/או אישור רפואי, ככל שנדרש לפי דין;
(ד) הוא יישא באחריות הבלעדית לכל היבט הנוגע להעסקת העובד, לרבות בטיחות, תנאי העסקה ותשלום.

מובהר בזאת כי הפלטפורמה אינה מעסיקה, אינה ספקית כוח אדם, ואינה צד ליחסי עובד–מעסיק, וכי לא מתקיימים בינה לבין המשתמשים יחסי עבודה מכל סוג שהוא.

הפלטפורמה רשאית, אך אינה מחוייבת, להפעיל מנגנונים טכנולוגיים לצורך התאמת משרות לפי גיל, לרבות הגבלת הצגת משרות מסוימות לעובדים מתחת לגיל 18. אין במנגנונים אלו כדי להוות התחייבות לעמידה בדרישות הדין, והם נועדו לסיוע בלבד.

המשתמש רשאי לעדכן את תאריך לידתו בפרופיל האישי. עדכון כאמור ייחשב כהצהרה מחודשת בדבר נכונות הפרטים, והפלטפורמה רשאית לתעד שינויים אלו, לרבות מועד העדכון ופרטים טכניים נלווים, לצרכים משפטיים, תפעוליים ובקרת שימוש.

המשתמשים מסכימים כי האחריות המלאה והבלעדית לעמידה בהוראות הדין, לרבות בכל הנוגע להעסקת קטינים, חלה עליהם בלבד, וכי לא תהיה להם כל טענה, דרישה או תביעה כלפי הפלטפורמה בקשר לכך.` },
