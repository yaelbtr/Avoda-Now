...
CREATE TABLE "categories" (
	...
	"allowedForMinors" boolean DEFAULT true NOT NULL,
...
ALTER TABLE "birthdate_changes" ADD CONSTRAINT "birthdate_changes_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "legal_acknowledgements" ADD CONSTRAINT "legal_acknowledgements_job_id_jobs_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "email_unsubscribes_token_idx" ON "email_unsubscribes" USING btree ("token");--> statement-breakpoint
